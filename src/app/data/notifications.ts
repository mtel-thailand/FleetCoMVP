...
export const mockNotificationLog: NotificationLogEntry[] = rebaseDemoDates<NotificationLogEntry[]>([
  ...
  { id: "NTF-004", eventTypeId: "new_request", message: "New request BK-2026-0001 — 2× Van, ad hoc, 27 Aug 2026.", recipient: "FleetCo Operations", portal: "fleetco", bookingId: "BK-2026-0001", channels: ["in_app", "email"], sentAt: "2026-08-14 08:10", read: true },
